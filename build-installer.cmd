...
SET TIMESTAMP_SERVER=/t http://timestamp.digicert.com
...
::: Sign the executable
"%WINDOWSKIT_PATH%signtool.exe" sign /debug /v /a /f "D:\Certificates\mycert.pfx" /d "Toggle Light/Dark" %TIMESTAMP_SERVER% "toggle.exe"
IF ERRORLEVEL 1 GOTO ERROR

::: Build the installer -- using .wixproj for WiX V4
...
ECHO.
DIR toggle.exe toggle.msi | FINDSTR /C:" toggle."
ECHO.
ECHO Done: %VER%
